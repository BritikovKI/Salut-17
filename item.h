...
public:
	...
	void Shoot(Level &lev, int dir, int left, int right)
	{
		...
		if (dir == 1)
		{
			interObjects.push_back(new Bullet("images/fire.png", "bullet", lev, 20, 10, right + 1, y, this, 1, dir, 50, 10, 10));

		}
		else
		{
			interObjects.push_back(new Bullet("images/fire.png", "bullet", lev, 20, 10, left - 20, y, this, 1, dir, 50, 10, 10));
