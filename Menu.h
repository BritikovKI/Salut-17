...
bool menu(RenderWindow & window) {
	...
	while (isMenu)
	{
		...
		if (IntRect(500, 30, 200, 30).contains(Mouse::getPosition(window))) { menu1.setColor(Color::Red); menuNum = 1; }
		if (IntRect(500, 90, 200, 30).contains(Mouse::getPosition(window))) { menu2.setColor(Color::Red); menuNum = 2; }
		if (IntRect(500, 150, 200, 30).contains(Mouse::getPosition(window))) { menu3.setColor(Color::Red); menuNum = 3; }
